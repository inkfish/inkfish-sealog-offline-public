...
- **HTTPS for devices.** Production GPS and offline installation require a trusted HTTPS origin. The [certificate guide](./cert-generation.md) covers the private CA workflow.
